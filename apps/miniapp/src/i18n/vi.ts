...
export const vi = {
  ...
  ctvOrder: {
    entry: 'Lên đơn hộ khách',
    entryHint: 'Đặt hàng giúp khách — bạn nhận hoa hồng',
    title: 'Lên đơn hộ khách',
    recipientHeading: 'Người nhận',
    recipient: 'Tên người nhận',
    phone: 'Số điện thoại',
    street: 'Địa chỉ (số nhà, đường)',
    products: 'Sản phẩm',
    searchProduct: 'Tìm sản phẩm để thêm…',
    chooseVariation: 'Chọn phân loại',
    noProductsFound: 'Không tìm thấy sản phẩm phù hợp',
    quantity: 'SL',
    paymentHeading: 'Thanh toán',
    cod: 'COD (thu hộ)',
    codHint: 'Thu tiền khi giao',
    bankTransfer: 'Chuyển khoản',
    bankHint: 'Khách chuyển trước',
    note: 'Ghi chú',
    notePlaceholder: 'Ghi chú cho đơn (không bắt buộc)…',
    goodsSubtotal: 'Tạm tính hàng',
    shipNote: 'Phí ship tính khi tạo đơn',
    submit: 'Tạo đơn hộ khách',
    emptyItems: 'Thêm ít nhất 1 sản phẩm',
    phoneInvalid: 'Số điện thoại chưa đúng',
    requiredField: 'Vui lòng nhập',
    successTitle: 'Đã tạo đơn hộ khách 🎉',
    orderCode: 'Mã đơn',
    orderTotal: 'Tổng tiền',
    createAnother: 'Lên đơn khác',
    done: 'Xong',
    openPayment: 'Mở trang thanh toán (gửi khách)',
    viewOrder: 'Xem đơn',
  ...
  community: {
    ...
    hasBestAnswer: 'Đã có câu trả lời hay',
    loadMore: 'Xem thêm',
    edit: 'Sửa',
    delete: 'Xoá',
    deleted: 'Đã xoá bài',
    ...
    moderation: 'Kiểm duyệt cộng đồng',
    tabPending: 'Chờ duyệt',
    tabReports: 'Báo cáo',
    approve: 'Duyệt',
    reject: 'Từ chối',
    approved: 'Đã duyệt bài',
    rejected: 'Đã từ chối bài',
    ...
    level4: 'Cổ thụ',
    events: 'Sự kiện',
    joinEvent: 'Đăng bài dự thi',
    eventEntries: 'Bài dự thi',
    eventReward: 'Thưởng',
    eventEnds: 'Kết thúc',
    eventStartLabel: 'Bắt đầu',
    eventTitlePlaceholder: 'Tên sự kiện',
    eventDescPlaceholder: 'Mô tả sự kiện (không bắt buộc)',
    eventCoverLabel: 'Ảnh bìa sự kiện',
    eventRewardLabel: 'Thưởng TubuXu',
    createEvent: 'Tạo sự kiện',
    eventCreated: 'Đã tạo sự kiện 🎉',
    closeEvent: 'Đóng',
    eventClosed: 'Đã đóng sự kiện',
    pickWinner: 'Chọn người thắng',
    winnerPicked: 'Đã chọn người thắng',
